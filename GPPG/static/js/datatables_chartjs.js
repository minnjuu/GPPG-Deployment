  ...
  var C = {
      prepare: function (t) {
        var e,
          ...
          n,
          i = [];
        for (e = 0, a = t.length; e < a; ++e) for (r = 0, o = t[e].length; r < o; ++r) (n = t[e][r]), i.push(n), (n.$layout = { _box: new k(), _hidable: !1, _visible: !0, _set: e, _idx: r });
        return (
          i.sort(function (t, e) {
            var r = t.$layout,
              a = e.$layout;
        ...
        i &&
          (function (t) {
            ...
            for (e = 0, r = t.length; e < r; ++e)
              (o = (a = t[e]).$layout)._visible && ((l = new Proxy(a._el, { get: (t, e) => t.getProps([e], !0)[e] })), (n = a.geometry()), (i = $(l, a.model(), n)), o._box.update(i, n, a.rotation()));
            (function (t, e) {
              var r, a, o, n;
